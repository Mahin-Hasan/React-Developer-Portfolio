    ...
    <section className='relative w-full h-screen mx-auto'>
      <div className={`${styles.paddingX} absolute inset-0 top-[120px] max-w-7xl mx-auto flex flex-row items-start gap-5`}>
        ...
        <div>
          ...
          <p className={`${styles.heroSubText} mt-2 text-white-100`}>I am a <span className='text-[#915eff] font-semibold'>MERN</span> Stack developer, <br className='sm:block hidden' /> building functional web applicaiton</p>
        </div>
      </div>
      <ComputersCanvas />
